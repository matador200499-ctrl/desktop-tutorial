...
def generate_script(topic, duration_minutes=15):
    ...
    # تحقق مبكر: هل المفتاح موجود أصلاً؟
    if not os.getenv("GROQ_API_KEY"):
        print("FATAL: متغير البيئة GROQ_API_KEY غير موجود أو فاضي.")
        print("تأكد إنه مضاف في GitHub Secrets وإنه مُمرَّر في ملف الـ workflow.")
        sys.exit(1)
    ...
    try:
        ...
        traceback.print_exc()
        print("=" * 60)
        # نوقف الـ workflow هنا بدل ما نكمل على script.json ناقص
        sys.exit(1)
